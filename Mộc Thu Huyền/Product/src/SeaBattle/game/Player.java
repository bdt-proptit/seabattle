...
public class Player {
    ...
    private ArrayList<Position> shoots = new ArrayList<>();
    ...
    private ArrayList<Ship> initShips() {
        ...
        for (ShipType type : ShipType.values()) {
            for (int i = 0; i < type.getNumShips(); i++) {
                list.add(new Ship(ShipType.toVietNamNameShip(type), type.getShipLength()));
            }
        }
        return list;
    }
...
//    }
    ...
    public void addAllShips() {
        if (!isAI) {
            ...
            String messageInputDirection = "- Enter Direction (h/v): ";
